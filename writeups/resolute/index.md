...
<br/>
Resolute was retired. It's a very easy Windows box with enumeration of common ports and gaining access to machine via founded creds, Again enumerating for second user creds. I'll show how to exploit if the User is in DNSAdmin group and to gain Domain Admin privs, So let's get start ...<br/>
